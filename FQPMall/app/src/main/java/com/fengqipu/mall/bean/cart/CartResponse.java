...
public class CartResponse extends BaseResponse {
    ...
    public static class CartRecord {
        ...
        public CartRecord(String createTime, String userID, String picUrl, double price, String style, int count, String shopID, String objectName, String shopName, String recordID, String contentID, String size) {
            this.createTime = createTime;
            this.userID = userID;
            this.picUrl = picUrl;
            this.price = price;
