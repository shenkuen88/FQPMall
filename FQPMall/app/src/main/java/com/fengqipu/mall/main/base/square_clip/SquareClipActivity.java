...
public class SquareClipActivity extends BaseActivity {
    private ClipSquareImageLayout mClipImageLayout;
    private String path;
    ...
    public void initView() {
        ...
        mClipImageLayout = (ClipSquareImageLayout) findViewById(R.id.id_clipImageLayout);
