...
{
    private static final String COOKIE_NAME_STORE = "frbao_names";

    private static final String COOKIE_NAME_PREFIX = "frbao_cookie_";
    ...
    {
        cookiePrefs = context.getSharedPreferences(Constants.BASE_PROJECT, Context.MODE_PRIVATE);
