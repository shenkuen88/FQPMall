...
public final class SecurityUtils
{
    ...
    private static String keyBytes ="";
//    private static String keyBytes = get32MD5Str(BbjrJni.getAppName()).substring(0, 16);
     ...
     * 获取MD5加密
     */
    public static String encodeMD5Str(String mTime)
            throws Exception
    {
        String srcKey = Constants.localKey;
        String msg = "";
        String time = mTime;
        msg = time + srcKey;
        return get32MD5Str(msg);
    }
    ...
    public static String timeStr()
    {
        ...
        String time = now.getTimeInMillis() / 1000 + "";
        return time;
    }
