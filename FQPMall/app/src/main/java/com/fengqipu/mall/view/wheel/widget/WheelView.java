...
package com.fengqipu.mall.view.wheel.widget;
...
import com.fengqipu.mall.view.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private  int[] SHADOWS_COLORS = new int[]{ 0xcefafafa, 0xaafafafa, 0xffffff };//由外层到中间的shadows
