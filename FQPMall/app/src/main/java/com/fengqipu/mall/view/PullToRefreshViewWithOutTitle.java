...
public class PullToRefreshViewWithOutTitle extends LinearLayout
{
    ...
    public PullToRefreshViewWithOutTitle(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public PullToRefreshViewWithOutTitle(Context context)
    {
        super(context);
        init();
    }
    ...
    {
        // header view
        mHeaderView = mInflater.inflate(R.layout.refresh_header_with_padding, this, false);
...
//            mHeaderUpdateTextView.setVisibility(View.VISIBLE);
    ...
    public void onHeaderRefreshComplete()
    {
        ...
        mHeaderImageView.setImageResource(R.mipmap.pulltorefresh_arrow);
        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
    ...
    public void onFooterRefreshComplete()
    {
        ...
        mFooterImageView.setImageResource(R.mipmap.pulltorefresh_arrow_up);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
...
//            mHeaderUpdateTextView.setVisibility(View.VISIBLE);
    ...
    {
        void onFooterRefresh(PullToRefreshViewWithOutTitle view);
    }
    ...
    {
        void onHeaderRefresh(PullToRefreshViewWithOutTitle view);
    }
}
